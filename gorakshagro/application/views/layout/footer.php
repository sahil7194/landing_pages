            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="widget footer-about-us">
                  ...
                  <p class="mb-20">Goraksh Agro makes your fruits & vegetables shopping even simpler.</p>
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="widget footer-links">
                  ...
                  <ul>
                    ...
                    <li><?php echo anchor('home/p/about-us','About Us'); ?></li>
                    <li><?php echo anchor('home/p/contact','Contact Us'); ?></li>
                    <li><?php echo anchor('privacy-policy','Privacy Policy'); ?></li>
                    <li><?php echo anchor('terms-and-condtions','Terms &amp; Conditions'); ?></li>
                    <li><?php echo anchor('cancellation-refund-policy','Cancellation/Refund Policy'); ?></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-6 col-xs-12 last">
                ...
                <div class="developed_by_box" style="margin-top:25px; ">
                    <a href="https://www.codzera.com" target="_blank" class="developed_by">Dzine and developed by <img src="https://www.codzera.com/images/codzera-z-white.png" title="Codzera Technologies" alt="Codzera Technologies" width="25px"></a>
                  </div>
