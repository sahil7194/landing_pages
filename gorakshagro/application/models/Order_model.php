		...
		if($this->cart->total_items() > 0){
			...
			if($this->session->userdata('delivery_address_id')){
				...
				$order_data = array('order_ref_id'=>$order_ref_id,
					...
					'packaging_charges'=>$this->cart->format_number($this->session->userdata('packaging_charges')),
					'shipping_charges'=>$this->cart->format_number($this->session->userdata('shipping_charges')),
					'total'=>$this->cart->format_number($this->session->userdata('total_payable_amount')),
					...
					'order_status_id'=>1,
					'address_code'=>$address_row->address_code,
					'ip'=>$this->getUserIP(),
