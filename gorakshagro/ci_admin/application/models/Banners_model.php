...
class Banners_model extends CI_Model {
	...
	public function resize_thumb($filename){
		...
		$imagesource1='../images/banners/'.$filename;
		$newimagesource1='../images/banners/thumbs/'.$filename;
		// Configuration 
	...
	public function delete_file_method($dataId,$data_field1='no_field'){
		...
		if($this->db->update('banners',$data)){
			unlink(WEBSITEPATH.'/images/banners/'.$row->$data_field);
		}
