            ...
            <div class="panel panel-default">
                <div class="panel-heading">                            
                    ...
                    <div class="col-sm-4 buttons_panel float-right">
                        <?php echo anchor('attributegroup','<button class="btn btn-primary">Cancel</button>');?>
                    </div>
                    <div class="clr"></div>
                </div>
...
$(document).ready(function() {    
    ...
    $("#country_id").on('change', function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>index.php/attributegroup/getData_states",
    ...
    $("#state_id").on('change', function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>index.php/attributegroup/getData_cities",
    ...
    $("#data_form").on('submit',(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>index.php/attributegroup/store",
            ...
            processData: false,
            success: function(result) {
                location.href="<?php echo base_url();?>index.php/attributegroup";
            },
            error: function(data){
