<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><?php if($title){ echo $title; }else{ echo 'Admin';} ?> Customers</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo form_open('reports/filter_customers', array('Method'=>'GET'));?>                    
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="email_verified" name="email_verified">
                                <option value="yes" <?php if($this->input->get('email_verified')=='yes'){ echo 'selected'; }?>>Yes</option>
                                <option value="no" <?php if($this->input->get('email_verified')=='no'){ echo 'selected'; }?>>No</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-12">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo $row->no_of_customers; ?></td>
                        </tr>                               
                        <?php 
                            }
                        }
