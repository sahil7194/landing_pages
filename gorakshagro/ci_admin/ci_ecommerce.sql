...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2018 at 06:29 PM
...
INSERT INTO `category` (`id`, `category`, `parent_id`, `status`) VALUES
(1, 'Mens', 0, 1),
(2, 'Jeans', 1, 1),
(3, 'Shirts', 1, 1),
(4, 'Womens', 0, 1),
...
INSERT INTO `panel_user` (`users_id`, `username`, `passcode`, `status`) VALUES
(1, 'admin', '617bae5fee9186ca4152efe6648ebbb3b8d4ec583b406ccfe29d0d2208dd467571f0b3c53bb83b72208757e2a450d6396f0f1f8bdb449d5f0a241c2d9b85bbfb/7PDqmmcxvvJH+vWTMqOIt5lg/Pdixkt9W50uM6/T5E=', 's_act');
...
INSERT INTO `product` (`id`, `product_name`, `status`) VALUES
(1, 'b', 1);
...
INSERT INTO `vendors` (`id`, `vendor_name`, `first_name`, `last_name`, `email`, `phone`, `mobile`, `fax`, `address1`, `address2`, `pincode`, `country_id`, `state_id`, `city_id`, `status`) VALUES
(1, '11', '21', '31', 'pravin2227@gmail.com', '51', '61', '71', '81', '91', '101', 101, 19, 1856, 1);
...
ALTER TABLE `vendors`
  ...
  ADD CONSTRAINT `vendors_ibfk_3` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`);
